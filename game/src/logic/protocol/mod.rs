use prost::Message;
use protocol::{frame::parse_function_frame, generated::{chain::{BlockProposal, BlockProposalFinalResponse, BlockProposalResponse, Blockchain}, msg::{ClientHandlers, Presentation}}};
